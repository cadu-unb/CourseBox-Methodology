...
## 🔄 Etapas da metodologia -> PLIA-DF

1. 🚧[Elaboração](1_preparation.md)
...
Eu, @Cadu, fico a disposição para realizar correções no caso de eventuais  dúvidas ou ambiguidades no corpo da metodologia.